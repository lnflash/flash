...
export const isBeforeExpiry = async (
  o: ValidationInputs,
...
export const transferMin = async (
  o: ValidationInputs,
): Promise<true | ValidationError> => {
...
export const transferMax = async (
  o: ValidationInputs,
): Promise<true | ValidationError> => {
...
export const hasSufficientBalance = async (
  ...
  else if (balance instanceof USDAmount && o.ibexTrx.usd.isGreaterThan(balance))
...
export const hasErpParty = async (
  o: ValidationInputs,
): Promise<true | ValidationError> => {
...
export const validate = async (
  ...
  validators: ValidationFn<ValidationInputs>[],
