...
export const OPS_DISCORD_WEBHOOK_URL = env.OPS_DISCORD_WEBHOOK_URL
export const PROXY_CHECK_APIKEY = env.PROXY_CHECK_APIKEY
export const NOSTR_PRIVATE_KEY = env.NOSTR_PRIVATE_KEY

export const ADMIN_CONFIG = {
  GALOY_ADMIN_PORT: env.GALOY_ADMIN_PORT,
  ERPNEXT_JWT_SECRET: env.ERPNEXT_JWT_SECRET,
}

// DigitalOcean Spaces
export const DO_SPACES_ENDPOINT = env.DO_SPACES_ENDPOINT
export const DO_SPACES_REGION = env.DO_SPACES_REGION
export const DO_SPACES_BUCKET = env.DO_SPACES_BUCKET
export const DO_SPACES_ACCESS_KEY = env.DO_SPACES_ACCESS_KEY
export const DO_SPACES_SECRET_KEY = env.DO_SPACES_SECRET_KEY

// ID verification (docs/id-verification.md)
export const UPGRADE_EVIDENCE_STRICT = env.UPGRADE_EVIDENCE_STRICT
export const EVIDENCE_RETENTION_YEARS = env.EVIDENCE_RETENTION_YEARS
export const EVIDENCE_RETENTION_DRY_RUN = env.EVIDENCE_RETENTION_DRY_RUN
