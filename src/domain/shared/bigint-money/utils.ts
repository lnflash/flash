/**
 * This file was copied from the bigint-money library
 */
    ...
    case "number":
      if (!Number.isSafeInteger(input)) {
        throw new UnsafeIntegerError(
          "The number " +
            input +
            ' is not a "safe" integer. It must be converted before passing it',
        )
      }
...
/**
 * This function takes a bigint that was multiplied by PRECISION_M, and returns
