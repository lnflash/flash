...
**Repo:** `lnflash/flash`
**HEAD as of session close:** `0eedf92` (cascade #11 — PROD-A..E → OPS-45..49 rename)
...
**PROD-A..E filed as OPS-45..49 (cascade #11, 2026-04-23 12:30 ET):** Per Dread 12:19 ET ("these decisions need to be made with Charlene in Linear. File them under the Operations team and assign Charlene, and Jabari will be helping her") + 12:25 ET "approved". Five commercial-signoff tickets now live on the **Operations team** as [OPS-45](https://linear.app/island-bitcoin/issue/OPS-45) (Bridge limits, due 2026-05-04) · [OPS-46](https://linear.app/island-bitcoin/issue/OPS-46) (Bridge fees, due 2026-04-29) · [OPS-47](https://linear.app/island-bitcoin/issue/OPS-47) (Flash markup, due 2026-04-29) · [OPS-48](https://linear.app/island-bitcoin/issue/OPS-48) (Flash-side overlay caps, due 2026-05-04) · [OPS-49](https://linear.app/island-bitcoin/issue/OPS-49) (quote/confirmation UX, due 2026-05-06). Charlene is assignee on all five; Jabari subscribed as engineering liaison. OPS added as a second team on the Bridge Wallet Integration project (it was ENG-only) so the tickets render on this roadmap. `blocks` relations set against ENG-354 / ENG-356+ENG-358 / ENG-356 / ENG-355 / ENG-342+ENG-346 respectively. All 5 Urgent.
...
| 11 | `0eedf92` | 2026-04-23 12:30 ET | **PROD-A..E filed as OPS-45..49 on the Operations team.** Per Dread 12:19 ET directive + 12:25 ET approval. First `issueCreate` attempt errored `"project not in same team as issue"` because the Bridge project was ENG-only; fixed by `projectUpdate(teamIds: [ENG, OPS])`. Then 5 issueCreate + 6 issueRelationCreate mutations landed. Tickets: [OPS-45](https://linear.app/island-bitcoin/issue/OPS-45) Bridge limits (May 4, blocks ENG-354) · [OPS-46](https://linear.app/island-bitcoin/issue/OPS-46) Bridge fees (Apr 29, blocks ENG-356+ENG-358) · [OPS-47](https://linear.app/island-bitcoin/issue/OPS-47) Flash markup (Apr 29, blocks ENG-356) · [OPS-48](https://linear.app/island-bitcoin/issue/OPS-48) overlay caps (May 4, blocks ENG-355) · [OPS-49](https://linear.app/island-bitcoin/issue/OPS-49) quote UX (May 6, blocks ENG-342+ENG-346). All Urgent, Charlene assignee, Jabari subscribed. Doc-side: rewrote every inline `PROD-A..E` reference in LINEAR-PROPOSAL (TL;DR, §1.1 ENG-355, §1.3 Nick row, §1.4 Dread ongoing row, §2 W4 row, §3 ASCII, §4 actions table, §5A.1 KYC-ceiling non-goals, §7 guardrails) and SESSION-CONTEXT (callout, Nick W4, Dread ongoing, next-steps bullet 4) to point at live OPS-* IDs. Total mutations: 5 issueCreate + 6 issueRelationCreate + 1 projectUpdate = 12. |
...
W4: Quote/confirmation UX mobile ENG ticket — TBD, gated on [OPS-49](https://linear.app/island-bitcoin/issue/OPS-49) (Charlene's commercial sign-off filed cascade #11 2026-04-23)
...
Ongoing: ENG-279 close-out · ENG-298 caretaker (Phase-2 schema cleanup, reassigned 18:11 ET) · **[OPS-45](https://linear.app/island-bitcoin/issue/OPS-45)/[OPS-46](https://linear.app/island-bitcoin/issue/OPS-46)/[OPS-47](https://linear.app/island-bitcoin/issue/OPS-47)/[OPS-48](https://linear.app/island-bitcoin/issue/OPS-48) commercial oversight** (Charlene-owned since cascade #11; Dread is the contract-side counterpart with Bridge sales, coordinated via Jabari's subscription to each ticket — he does not assign himself) · Cashout V1 cross-project coordination · ERPNext contract counterpart (ENG-348 stays Ben-owned, Dread is contract-side) · **Linear cross-project blocks link from ENG-296 → Cashout V1 issue** (skipped in mirror per Dread "skip" decision — Dread sets manually in UI when target Cashout V1 ticket is identified)
...
4. ~~**PROD-A..E commercial sign-off**~~ — **DONE cascade #11 (2026-04-23 12:30 ET).** Filed as [OPS-45](https://linear.app/island-bitcoin/issue/OPS-45) / [OPS-46](https://linear.app/island-bitcoin/issue/OPS-46) / [OPS-47](https://linear.app/island-bitcoin/issue/OPS-47) / [OPS-48](https://linear.app/island-bitcoin/issue/OPS-48) / [OPS-49](https://linear.app/island-bitcoin/issue/OPS-49) on the Operations team (Charlene assignee, Jabari subscribed). `blocks` relations set against the gating engineering tickets. Remaining next-step on this item is now *resolution* of those 5 tickets, which is Charlene's work, not Dread's — Dread's role shifts to the contract-side Bridge-sales conversation (still open) + oversight via Jabari's subscription.
...
_Last pushed cascade: `0eedf92` — PROD-A..E filed as OPS-45..49 on Operations team (2026-04-23 12:30 ET, cascade #11)._
_Previous: `a25ff75` — dated schedule on all 37 open issues (21:18 ET, cascade #10)._
_Earlier: `4f9fd48` — NEW-*/FEE-* placeholder scrub across all 10 docs (18:50 ET, cascade #9)._
