...
jest.mock("@config", () => {
  ...
  return {
    ...
    getPaymentSendAttemptLimits: jest.fn(() => limits),
    getPaymentSendDailyAttemptLimits: jest.fn(() => limits),
    ...
    getGiftCardPurchaseAttemptLimits: jest.fn(() => limits),
    getGiftCardQuoteAttemptLimits: jest.fn(() => limits),
